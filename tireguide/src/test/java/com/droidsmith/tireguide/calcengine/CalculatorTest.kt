...
@RunWith(Parameterized::class) class CalculatorTest(private val loadWeight: Double,
													private val tireWidth: String,
													private val psi: Double) {
	private var calculator: Calculator = Calculator()

	companion object {
		@JvmStatic @Parameterized.Parameters(name = "{index}: Test with loadWeight={0}, tireWidth={1}, psi: {2}")
		fun data(): Iterable<Array<Any>> {
			return Arrays.asList(arrayOf(0.0, "20", -11),
								 arrayOf(8.0, "20", 0),
								 arrayOf(50.0, "20", 57),
	...
	@Test fun WhenCalculatingTirePressure_WithValidInput_ThenCorrectPressureIsGiven() {
	...
	private fun arePsiEqual(expectedPsi: Double, testPsi: Double): Boolean {
		return Math.round(expectedPsi).toDouble() == testPsi
	}
}
